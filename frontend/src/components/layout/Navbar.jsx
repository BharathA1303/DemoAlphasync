...
export default function Navbar({ onMenuToggle }) {
    ...
    const { marketOpen, sessionLabel, liveFeedActive } = useMarketSession();
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-1.5">
                ...
                {/* Broker Badge (reflects live AMDP feed vs local simulation) */}
                <div
                    className={cn(
                    ...
                    title={liveFeedActive ? 'Live AMDP Data Feed (Active)' : 'Simulated Replay Data Feed (Active)'}
                >
                    <div className={cn(
                        "w-2 h-2 rounded-full animate-pulse",
                        liveFeedActive ? 'bg-primary-400' : 'bg-emerald-400'
                    )} />
                    <span className="text-xs font-medium text-heading">
                        {liveFeedActive ? 'Live Feed' : 'Simulated Feed'}
                    </span>
                </div>
