...
def generate_mock_mcx_data(target_date: date) -> List[Dict[str, Any]]:
    ...
    produce, from fixed anchor base prices - this is the primary source of
    mock commodities data (run_ingestion.py --mock calls this for the MCX
    branch symmetrically with NSE/BSE).
    """
