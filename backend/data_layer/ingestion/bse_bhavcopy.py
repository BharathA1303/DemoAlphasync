...
# every day (see mock_price_continuity.py).
_BSE_MOCK_ANCHORS = {
    "500325": (2800.0, 0.0003),   # Reliance
    "500180": (1650.0, 0.0003),   # HDFC Bank
    "500209": (1500.0, 0.0004),   # Infosys
    "532540": (3600.0, 0.0003),   # TCS
    "532898": (600.0, 0.0002),    # UCO Bank-ish placeholder
    "500112": (600.0, 0.0003),    # SBI
    "500312": (280.0, 0.0002),    # ONGC
    "532215": (1050.0, 0.00035),  # Axis Bank
    "500696": (2450.0, 0.0002),   # HUL
    "500510": (3800.0, 0.0003),   # L&T
}
...
def generate_mock_bse_data(target_date: date) -> List[Dict[str, Any]]:
    ...
    for symbol, (anchor, drift) in _BSE_MOCK_ANCHORS.items():
