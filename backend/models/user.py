# models/user.py - User and admin management models with enhanced security and audit logging
import uuid
...
class User(Base):
    ...
    futures_watchlists = relationship(
        "FuturesWatchlist", cascade="all, delete-orphan"
    )
