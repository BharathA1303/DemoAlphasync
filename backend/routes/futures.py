...
async def list_contracts(
    ...
    Response:
        ...
        Each contract includes:
            - contract_symbol: Exchange trading symbol (e.g., RELIANCE25MAR2026FUT)
...
async def get_contract_quote(
    ...
    Sources (in order):
        ...
        2. Existing market_data service (the internal simulation engine)

    Parameters:
        contract_symbol: the internal simulation engine futures symbol (e.g., RELIANCE25MAR2026FUT)
...
async def get_contract_history(
    ...
    Parameters:
        contract_symbol: the internal simulation engine futures symbol
