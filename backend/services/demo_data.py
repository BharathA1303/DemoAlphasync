...
Used as a fallback when the internal simulation engine data feed is not configured/enabled,
so the demo platform always shows data even without real credentials.
