...
Pre-loads from futures_service._futures_contracts (populated at startup from the
the internal simulation engine data feed) and maintains multiple in-memory indexes for fast,
reconnect-safe lookups without any API/REST calls.
"""
